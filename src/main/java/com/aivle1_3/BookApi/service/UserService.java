...
public class UserService {
    ...
    public UserLoginResponseDto signup(UserSignupRequestDto dto) {
        ...
        return new UserLoginResponseDto(savedUser.getId(), savedUser.getUserid(), savedUser.getName());
    }
    ...
    public UserLoginResponseDto login(UserLoginRequestDto dto) {
        ...
        return new UserLoginResponseDto(user.getId(), user.getUserid(), user.getName());
    }
}
